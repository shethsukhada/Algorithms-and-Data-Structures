// reference - http://users.csc.tntech.edu/~mjkosa/2400f12/NQueens2.java
...
public class CS60813ESheth extends JFrame implements Runnable
{
	...
	private int sol, calls;
     ...
     public CS60813ESheth(int delta)
     {
    ...
    public static void main(String [] args)
    {
		...
		if (args != null && args.length >= 1)
			...
			delay = 0;
		CS60813ESheth win = new CS60813ESheth(delay);
		...
		public void actionPerformed(ActionEvent e)
		{
			if (e.getSource() == runDemo)
			{
				if (!paused)
				{
					...
					runThread = new Thread(CS60813ESheth.this);
					runThread.start();
				}
				else
				{
